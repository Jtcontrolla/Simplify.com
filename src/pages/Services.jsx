    ...
    return (
        <section className="bg-[#19191B mt-35" id="services">
            <div className="flex justify-center">
                <h2 className="text-white font-[Inter] text-5xl lg:text-[60px] font-[600] lg:leading-[70.6px] text-center md:w-[695px] lg:h-[140px] lg:mt-15 px-[30px] relative z-20">
                    The Service We Provide
                    For You
                </h2>
            </div>

            <div className="absolute top-[1848px] right-[1060px] z-10 hidden lg:block">
                <img src={Triangles} alt="Triangles" width={60}/>
            </div>
            <div className="absolute top-[1950px] right-[110px] rotate-[31.42deg] hidden lg:block">
                <img src={Plus} alt="Plus" width={40}/>
            </div>
            <div className="absolute top-[2660px] right-[1120px] -rotate-[25.34deg] hidden lg:block">
                <img src={Plus} alt="Plus" width={40}/>
            </div>
            ...
            <div 
                className="absolute left-[22px] top-[1960px] h-[1400px] w-[860px] rounded-[233.5px] 
                bg-gradient-to-b from-[rgba(251,168,28,0.4)] to-[rgba(224,86,136,0.15)] blur-[300px] 
                opacity-30 rotate-[67.1deg] hidden lg:block">
            </div>
